...
export default function HeroBlock({ data }) {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#0f1714] text-white">

      {/* Background glow */}
      <div className="absolute inset-0">
        <div className="absolute top-[-120px] left-[-120px] w-[420px] h-[420px] rounded-full bg-teal-500/20 blur-3xl" />
        <div className="absolute bottom-[-150px] right-[-100px] w-[500px] h-[500px] rounded-full bg-lime-400/15 blur-3xl" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 text-center">
        ...
        {data.heading && (
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold max-w-5xl mx-auto leading-tight">
        ...
        {data.description && (
          <p className="text-lg md:text-xl text-white/65 mt-8 max-w-3xl mx-auto leading-relaxed">
            {data.description}
          </p>
        )}
