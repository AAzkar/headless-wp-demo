    ...
    <StaggerReveal>
      <section className="relative w-full overflow-hidden bg-[#0f1714] py-28 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-item">
            {plans.map((plan, index) => (
              <div
                ...
                className={`transition duration-300 rounded-3xl border p-8 backdrop-blur-xl ${plan.highlighted
                  ? 'bg-gradient-to-b from-teal-500/20 to-lime-400/10 border-teal-300/30 shadow-2xl shadow-teal-500/20'
              ...
              >
                ...
                <Link
                  href={plan.buttonUrl}
                  className={`w-full inline-flex justify-center px-6 py-4 rounded-full font-semibold transition ${plan.highlighted
